...
/** These exercises mirror the ones from `OptionExercises2.scala`, they are for
  * the purpose of teaching for-comprehension, which is very useful for working
  * with `Option`.
  */

/** Rewrite this function using for-comprehension syntax.
  *
  * scala> findJobIdByHumanIdUsingFor(1) > None
  *
  * scala> findJobIdByHumanIdUsingFor(2) > Some(1)
  */
...
/** Rewrite this function using for-comprehension syntax.
  *
  * scala> findJobByHumanIdUsingFor(2) > Some(Job("Teacher", "Expert in their
  * field"))
  */
...
/** Rewrite this function using for-comprehension syntax.
  *
  * scala> findJobNameByHumanIdUsingFor(2) > Some("Teacher")
  *
  * scala> findJobNameByHumanIdUsingFor(1) > None
  */
